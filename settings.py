...
DEFAULT_DB_DBUSER = os.getenv('DEFAULT_DB_DBUSER', 'codo')
DEFAULT_DB_DBPWD = os.getenv('DEFAULT_DB_DBPWD', 'Admin@123.com')
...
READONLY_DB_DBUSER = os.getenv('READONLY_DB_DBUSER', 'codo')
READONLY_DB_DBPWD = os.getenv('READONLY_DB_DBPWD', 'Admin@123.com')
